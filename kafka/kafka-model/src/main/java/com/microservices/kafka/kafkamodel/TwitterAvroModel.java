...
public class TwitterAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3083592693973477147L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TwitterAvroModel\",\"namespace\":\"com.microservices.kafka.kafkamodel\",\"fields\":[{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"text\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"createdAt\",\"type\":[\"null\",\"long\"],\"logicalType\":[\"null\",\"date\"]}]}");
   ...
   */
  public static com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder newBuilder() {
    return new com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder();
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder newBuilder(com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder other) {
    if (other == null) {
      return new com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder();
    } else {
      return new com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder(other);
    }
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder newBuilder(com.microservices.kafka.kafkamodel.TwitterAvroModel other) {
    if (other == null) {
      return new com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder();
    } else {
      return new com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TwitterAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.microservices.kafka.kafkamodel.TwitterAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder setUserId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder setText(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder setCreatedAt(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.kafkamodel.TwitterAvroModel.Builder clearCreatedAt() {
      createdAt = null;
